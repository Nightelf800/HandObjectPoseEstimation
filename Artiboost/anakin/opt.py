...
submit_order = "python train/submit_reload.py --cfg config_eval/eval_ho3dv2_clasbased_artiboost.yaml \
  --gpu_id 0 --submit_dump --filter_unseen_obj_idxs 11 --batch_size 100"

train_order = "python train/train_artiboost.py --cfg config_eval/ho3dv2_clasbased_jlol_artiboost2.yaml \
  --gpu_id 0 --submit_dump --filter_unseen_obj_idxs 11 --batch_size 100 --gpu_render_id 0"

data_eval_order = "--cfg config_eval/eval_dataset.yaml \
  --gpu_id 0 --submit_dump --filter_unseen_obj_idxs 11 --batch_size 100"
...
arg, custom_arg_string = parser.parse_known_args(submit_order.split())
