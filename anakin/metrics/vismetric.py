...
class Vis2DMetric(VisMetric):
    ...
    def feed(self, preds: Dict, targs: Dict, **kwargs):
        ...
        elif ("joints_2d" and "corners_2d") in preds:
        ...
        pred_image = self.draw_batch_joints_image(
            ...
            batch_corners2d=pred_corners_2d if preds["use_obj"] else None,
            batch_gt_root2d=gt_root,
            batch_joints_vis=joints_vis,
            batch_corners_vis=corners_vis if preds["use_obj"] else None,
        )
        ref_image = self.draw_batch_joints_image(
            batch_images=image,
            batch_joints2d=joints_2d,
            batch_corners2d=corners_2d if preds["use_obj"] else None,
            batch_gt_root2d=gt_root,
            batch_joints_vis=joints_vis,
            batch_corners_vis=corners_vis if preds["use_obj"] else None,
        )
